            ...
            <div>
                <div class="w-full flex items-center font-bold p-2 my-1">
                    <div class="w-full flex items-center mt-2">
                        ...
                        <span class="w-56">Email</span>
                        <span class="w-64 truncate">Chức vụ</span>
                        ...
                        <div x-data="{ messageHover: false }" @mouseover="messageHover = true" @mouseleave="messageHover = false"
                            ...
                            <a href="">
                                <div class="flex items-center">
                                    <span class="w-44 pr-2 truncate">{{ $user->name }}</span>
                                    <span class="w-56 truncate">{{ $user->email }}</span>
                                    <span class="w-64 truncate">{{ $user->chuc_vu }}</span>
