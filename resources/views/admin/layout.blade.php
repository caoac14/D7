...
<body class="font-sans antialiased">
    <div class="min-h-screen bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        <div class="max-w-7xl mx-auto shadow-lg rounded-md border border-gray-200">
            <div class="flex p-4 bg-gray-200 justify-between h-20">
                <div class="flex">
                    <!-- Logo -->
