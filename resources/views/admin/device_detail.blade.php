                ...
                <div>
                    <div class=" grid grid-cols-4 gap-4 p-4">
                        @if(count($typeDeviceLists) > 0)
                                                ...
                                                <div
                                                    ...
                                                    <form action="{{ route('admin.delete_device', $device->id) }}"
                                                        ...
                                                        <input type="text" name="devide" class="hidden"
                                                            value="{{ $device->id }}">
                                                        <button type="submit"
                                                            data-modal-toggle="defaultModal-{{ $device->id }}" type="button"
                            ...
                            @endforeach
                        @else
                        <div class="col-span-4 flex p-3 mt-2 text-base text-blue-700 border border-blue-300 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400 dark:border-blue-800" role="alert">
